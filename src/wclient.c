...
// Function to sanitize filename and remove directory traversal patterns
void sanitize_filename(char *filename) {
    char *pos;
    while ((pos = strstr(filename, "../")) != NULL) {
        // Shift the remaining characters to remove the "../" pattern
...
void client_send(int fd, char *filename) {
    ...
    // Sanitize the filename to remove directory traversal patterns
